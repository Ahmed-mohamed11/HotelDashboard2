...
const BookingTable = ({ openCreate, openPreview }) => {
    ...
    return (
        <div className={` ${inter.className}`}>
            <section className=" my-4 sm:p-5 dark:text-white">
                    ...
                    <div className="bg-white relative shadow-md rounded-lg dark:bg-gray-dark dark:text-white">
                        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                            ...
                            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3">
                                ...
                                <button
                                    onClick={openCreate}
                                    className="flex items-center justify-center text-white bg-green-700 hover:bg-green-600 focus:ring-4 focus:ring-green-300 rounded-lg text-sm px-4 w-40 py-2 duration-150 ease-in-out"
                                >
